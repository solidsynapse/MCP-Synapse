...
- Public repository surface policy lock (D-039): the public repository must remain product-first; internal orchestration/handoff/probe/backup workflow artifacts must stay off the primary public surface unless SSOT/release-integrity requires them. Retained historical/internal materials must be archived under clearly labeled internal paths with deterministic, evidence-backed, reversible cleanup.
