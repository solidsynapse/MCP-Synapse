...
class XAIHTTPError(XAIError):
    def __init__(self, status_code: int, message: str) -> None:
        super().__init__(message)
        self.status_code = int(status_code)


class XAIResponseError(XAIError):
    pass


class XAIProviderClient:
    provider_id = "xai"
    ...
    def generate_content(self, prompt: str, *, stream: bool = False) -> dict[str, Any]:
        ...
        try:
            ...
            raise XAIHTTPError(status_code, f"HTTP {status_code}: {_GENERIC_HTTP_MESSAGE}") from http_exc
        except Exception as exc:
            raise XAIError(_GENERIC_UNREACHABLE_MESSAGE) from exc
    ...
    def _parse_response(self, raw: bytes) -> dict[str, Any]:
        try:
            ...
            raise XAIResponseError(_GENERIC_INVALID_JSON_MESSAGE) from exc
        ...
        try:
            ...
            raise XAIResponseError(_GENERIC_MALFORMED_RESPONSE_MESSAGE) from exc
